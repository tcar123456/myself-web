  ...
  },
  {
    ...
    features: [
      ...
      },
      {
        ...
        problem:
          "經常出差、跨國工作的人，每次都要對齊兩地的會議時間，但很多行事曆乾脆不做這塊。VoxPlan 內建 100 多個城市的時區，每個人可以設一個主要時區，再加最多 5 個常用時區，也可以選擇自動跟著手機系統的時區跑。要臨時換顯示時區時，點上方的地球圖示就能切換；切到日視圖會把本地時間與目標時區並排在兩欄，同一個行程在兩邊對應的時間一眼就看得到，不用心算時差。",
